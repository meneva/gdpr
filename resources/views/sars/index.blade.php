    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('sars.export.csv') }}" class="text-xs font-mono uppercase tracking-wide text-ink-500 hover:text-ink-900">CSV</a>
                <a href="{{ route('sars.export.pdf') }}" class="text-xs font-mono uppercase tracking-wide text-ink-500 hover:text-ink-900">PDF</a>
